...
const DEFAULT_SETTINGS = {
  ...
  videoPositions: [
    { label: 'DIRECTOR', pattern: 'main\\s*director', isDir: true },
    { label: 'BROADCAST DIR', pattern: 'broadcast\\s*director', isDir: true },
    { label: 'CAM 1', pattern: 'camera\\s*0?1\\b', isDir: false },
    { label: 'CAM 2', pattern: 'camera\\s*0?2\\b', isDir: false },
    { label: 'CAM 3', pattern: 'camera\\s*0?3\\b', isDir: false },
    { label: 'CAM 4', pattern: 'camera\\s*0?4\\b', isDir: false },
    { label: 'CAM 5', pattern: 'camera\\s*0?5\\b', isDir: false },
    { label: 'CAM 6', pattern: 'camera\\s*0?6\\b', isDir: false },
    { label: 'CAM 7', pattern: 'camera\\s*0?7\\b', isDir: false },
    { label: 'CAM 8', pattern: 'camera\\s*0?8\\b', isDir: false },
    { label: 'CAM 9', pattern: 'camera\\s*0?9\\b', isDir: false },
    { label: 'CAM 10', pattern: 'camera\\s*10\\b', isDir: false },
    { label: 'CAM 11/12', pattern: 'camera\\s*1[12]\\b|ptz', isDir: false },
  ],
};
